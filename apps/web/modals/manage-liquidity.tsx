...
export const ManageLiquidityModal: FunctionComponent<Props> = (props) => {
  ...
  const { walletModalOpen: showModalBase, accountActionButton } =
    useConnectWalletModalRedirect(
      {
        ...
        disabled:
          (selectedTabIndex === 0 && addLiquidityConfig.error !== undefined) ||
          isSendingMsg ||
          (selectedTabIndex === 1 &&
        ...
        children: selectedTabIndex === 0 ? "Add Liquidity" : "Remove Liquidity",
      },
