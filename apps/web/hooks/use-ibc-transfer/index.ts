 ...
 * @returns [Ollo account, counterparty account, observable amount config, isLoading, IBC transfer callback, custom withdrawal address manager if withdrawing]
 */
export function useIbcTransfer({
  ...
  AccountSetBase & CosmosAccount & CosmwasmAccount & OlloAccount,
  AccountSetBase & CosmosAccount & CosmwasmAccount & OlloAccount,
  AmountConfig,
  boolean,
  (
