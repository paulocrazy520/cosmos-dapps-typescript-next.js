...
import { UserSettings, HideDustUserSetting } from "./user-settings";
...
export class RootStore {
  ...
  public readonly queriesStore: QueriesStore<
    [CosmosQueries, CosmwasmQueries, OlloQueries]
  >;

  public readonly accountStore: AccountStore<
    [CosmosAccount, CosmwasmAccount, OlloAccount]
  >;
  ...
  constructor(
    ...
    this.chainStore = new ChainStore(
      ChainInfos,
      "ollo-testnet-1"
      // process.env.OLLO_CHAIN_ID,
      // (IS_TESTNET ? "osmo-test-4" : "ollo")
    );
    ...
    this.queriesStore = new QueriesStore(
      ...
      CosmosQueries.use(),
      CosmwasmQueries.use(),
      OlloQueries.use(this.chainStore.ollo.chainId)
    );
    ...
    this.accountStore = new AccountStore(
      ...
      OlloAccount.use({ queriesStore: this.queriesStore })
    );

    this.priceStore = new PoolFallbackPriceStore(
      this.chainStore.ollo.chainId,
      this.chainStore,
      ...
      "usd",
      this.queriesStore.get(this.chainStore.ollo.chainId).ollo!.queryGammPools,
      PoolPriceRoutes
    );
    ...
    this.queriesExternalStore = new QueriesExternalStore(
      ...
      this.priceStore,
      this.chainStore.ollo.chainId,
      IS_TESTNET ? "https://api.testnet.ollo.zone/" : undefined
    );
