...
export const olloChainInfo = {
  chainId: "ollo-testnet-1",
  chainName: "ollo",
  rpc: "https://rpc.ollo.zone",
  rest: "https://lcd.ollo.zone",
  bip44: {
    coinType: 118,
  },
  coinType: 118,
  ...
  features: ["stargate", "ibc-transfer", "ibc-go", "no-legacy-stdTx", "ibc-go"],
  explorerUrlToTx: "https://explorer.ollo.zone/tx/{txHash}",
};
