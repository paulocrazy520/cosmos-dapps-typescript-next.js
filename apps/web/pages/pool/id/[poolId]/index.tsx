...
//   const pool = queryOllo.queryGammPools.getPool(poolId as string);
//   const { bech32Address } = accountStore.getAccount(chainId);
//   const fiat = priceStore.getFiatCurrency(priceStore.defaultVsCurrency)!;

//   // eject to pools page if pool does not exist
//   const poolExists = queryOllo.queryGammPools.poolExists(poolId as string);
//   useEffect(() => {
//     if (poolExists === false) {
//       router.push("/pools");
//     }
...
//       );
//     }
//   }, [poolExists, pool, bech32Address, fiat, queryOllo, priceStore]);
...
//     bech32Address,
//     undefined,
//     pool ? queryOllo.queryGammPoolShare.getShareCurrency(pool.id) : undefined
//   );
...
//           }
//           if (gauge) {
//             await account.ollo.sendLockTokensMsg(
...
//           try {
//             await account.ollo.sendSuperfluidDelegateMsg(
...
//         ) {
//           try {
//             await account.ollo.sendLockAndSuperfluidDelegateMsg(
//               [
//                 {
//                   currency: lockLPTokensConfig.sendCurrency,
//                   amount: lockLPTokensConfig.amount,
...
//           availableToken={
//             pool
//               ? queryOllo.queryGammPoolShare.getAvailableGammShare(
//                 bech32Address,
//                 pool.id
//               )
//               : undefined
...
//             : []),
//         ]}
//         bgImageUrl="/images/Ollo-guy-in-lab.png"
//       />
...
//                   onClick={async () => {
//                     try {
//                       await account.ollo.sendUnPoolWhitelistedPoolMsg(
//                         pool.id,
//                         undefined,
//                         (tx) => {
//                           if (isError(tx))
...
//                               await queryOllo.querySyntheticLockupsByLockId
//                                 .get(lockId)
//                                 .waitFreshResponse();
//                             }
...
//                                 lockId,
//                                 isSyntheticLock:
//                                   queryOllo.querySyntheticLockupsByLockId.get(
//                                     lockId
...
//                             ) {
//                               await account.ollo.sendBeginUnlockingMsgOrSuperfluidUnbondLockMsgIfSyntheticLock(
//                                 locks,
//                                 undefined,
//                                 (tx) => {
//                                   if (isError(tx))
...
//                               await account.ollo.sendBeginUnlockingMsg(
...
const Pools: FunctionComponent<{}> = () => {
  ...
  return (
    <Slayout pgTitle={"Pools " + poolId}>
      <Split sideChildren={<LayoutCard title="Pool Info"></LayoutCard>}>
        <LayoutCard title="ATOM-OSMO Pool"></LayoutCard>
      </Split>
    </Slayout>
  );
};
