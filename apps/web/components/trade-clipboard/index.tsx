...
import { isError } from "@ollo/stores";
          ...
          if (tradeTokenInConfig.optimizedRoutePaths.length > 0) {
            ...
            for (
              ...
              const tokenOutCurrency =
                chainStore.olloObservable.currencies.find(
                  (cur) =>
            ...
            const tokenInCurrency = chainStore.olloObservable.currencies.find(
              (cur) =>
                cur.coinMinimalDenom ===
            ...
            try {
              ...
              // ]);
              if (routes.length === 1) {
                await account.ollo.sendSwapExactAmountInMsg(
                  routes[0].poolId,
                  tokenIn,
                  ...
                  "",
                  {
                    amount: [
                      {
                        denom: chainStore.ollo.stakeCurrency.coinMinimalDenom,
                        amount: "0",
                      },
                    ],
                  },
                ...
                await account.ollo.sendMultihopSwapExactAmountInMsg(
                  routes,
                  tokenIn,
                  maxSlippage,
                  "",
