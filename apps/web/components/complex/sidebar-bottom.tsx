...
export const SidebarBottom: FunctionComponent = observer(() => {
  ...
  const queries = queriesStore.get(chainStore.ollo.chainId);
  ...
  const osmoPrice = fiat
    ? new PricePretty(
        ...
        new Dec(
          priceStore.getPrice(
            chainStore.ollo.stakeCurrency.coinGeckoId ?? "Ollo"
          ) ?? 0
        )
      )
    : undefined;
    ...
    <div className="mt-4" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="flex place-content-between text-caption mb-4">
          <div className="flex gap-2">
            ...
            <span className="my-auto">
              {chainStore.ollo.stakeCurrency.coinDenom.toUpperCase()}
            </span>
          </div>
      ...
      {IS_FRONTIER ? (
        <p className="py-2 text-base text-white-high text-left flex items-center place-content-evenly">
          <a
            href="https://medium.com/Ollo/introducing-Ollo-frontier-d9da158b22d0"
            target="_blank"
            rel="noreferrer"
          >
        ...
        <>
          <div className="flex place-content-between transition-all overflow-x-hidden w-full">
            <a
              href="https://twitter.com/Ollozone"
              target="_blank"
