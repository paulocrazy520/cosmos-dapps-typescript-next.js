...
import * as WeightedPoolEstimates from "@ollo/math";
import { Pool } from "@ollo/pools";
import { OlloQueries } from "../queries";
import { osmosis } from "./msg/proto";
import * as Msgs from "./msg/make-msg";
import { OlloMsgOpts, defaultMsgOpts } from "./types";
import { StdFee } from "@cosmjs/stargate";
import { BondStatus } from "@keplr-wallet/stores/build/query/cosmos/staking/types";

export interface OlloAccount {
  ollo: OlloAccountImpl;
}

export const OlloAccount = {
  use(options: {
    msgOptsCreator?: (chainId: string) => DeepPartial<OlloMsgOpts> | undefined;
    queriesStore: IQueriesStore<CosmosQueries & OlloQueries>;
  }): (
    ...
    return (base, chainGetter, chainId) => {
      ...
      return {
        ollo: new OlloAccountImpl(
          base,
          chainGetter,
          chainId,
          options.queriesStore,
          deepmerge<OlloMsgOpts, DeepPartial<OlloMsgOpts>>(
            defaultMsgOpts,
...
export class OlloAccountImpl {
  constructor(
    protected readonly base: AccountSetBaseSuper & CosmosAccount,
    protected readonly chainGetter: ChainGetter,
    protected readonly chainId: string,
    protected readonly queriesStore: IQueriesStore<CosmosQueries & OlloQueries>,
    protected readonly _msgOpts: OlloMsgOpts
  ) {}
   ...
   *
   * https://docs.ollo.zone/developing/modules/spec-gamm.html#join-pool
   ...
   *
   * https://docs.ollo.zone/developing/modules/spec-gamm.html#join-swap-extern-amount-in
      ...
      (tx) => {
        if (tx.code == null || tx.code === 0) {
          ...
          routes.forEach(({ poolId }) =>
            queries.ollo?.queryGammPools.getPool(poolId)?.waitFreshResponse()
          );
        }
  ...
  /**
   * https://docs.ollo.zone/developing/modules/spec-gamm.html#swap-exact-amount-in
   * @param poolId Id of pool to swap within.
  ...
  /**
   * https://docs.ollo.zone/developing/modules/spec-gamm.html#swap-exact-amount-out
   * @param poolId Id of pool to swap within.
  ...
  /**
   * https://docs.ollo.zone/developing/modules/spec-gamm.html#exit-pool
  ...
  /**
   * https://docs.ollo.zone/developing/modules/spec-lockup.html#lock-tokens
    ...
    await this.base.cosmos.sendMsgs(
      ...
      (tx) => {
        if (tx.code == null || tx.code === 0) {
          ...
          queries.ollo?.queryAccountLocked
            .get(this.base.bech32Address)
            .waitFreshResponse();
          ...
          queries.ollo?.querySuperfluidDelegations
  ...
  /**
   * https://docs.ollo.zone/developing/modules/spec-lockup.html#begin-unlock-by-id
  ...
  /**
   * https://docs.ollo.zone/developing/ollo-core/modules/spec-superfluid.html#superfluid-unbond-lock
      ...
      (tx) => {
        if (tx.code == null || tx.code === 0) {
          ...
          queries.ollo?.queryLockedCoins
            .get(this.base.bech32Address)
            .waitFreshResponse();
          queries.ollo?.queryUnlockingCoins
            .get(this.base.bech32Address)
            .waitFreshResponse();
          queries.ollo?.queryAccountLocked
            .get(this.base.bech32Address)
          ...
          queries.ollo?.querySuperfluidDelegations
            .getQuerySuperfluidDelegations(this.base.bech32Address)
            .waitFreshResponse();
          queries.ollo?.querySuperfluidUndelegations
            .getQuerySuperfluidDelegations(this.base.bech32Address)
            .waitFreshResponse();
        }
  ...
  protected get queries() {
    ...
    return this.queriesStore.get(this.chainId).ollo!;
  }
