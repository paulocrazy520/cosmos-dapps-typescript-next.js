...
export interface OlloQueries {
  ollo?: OlloQueriesImpl;
}

export const OlloQueries = {
  use(
    olloChainId: string
  ): (
    ...
    return (
      ...
      return {
        ollo:
          chainId === olloChainId
            ? new OlloQueriesImpl(queriesSetBase, kvStore, chainId, chainGetter)
            : undefined,
      };
    };
  },
...
/** Root queries store for all Ollo queries. */
export class OlloQueriesImpl {
